...
from src.modules.emotion_dit_ablation0905_cond_dit_adaln import DitTalkingHead
...
def build_parser():
    ...
    parser.add_argument("--model_variant", type=str, default="emotion_dit_ablation0905_cond_dit_adaln")
