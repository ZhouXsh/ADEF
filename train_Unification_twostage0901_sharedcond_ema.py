...
# -----------------------------------------------------------------------------
VARIANT_NAME = "sharedcond_ema"
VARIANT_DESCRIPTION = (
    "Generic shared start + emotion-condition warm-start, then MEAD specialization, with corrected schedule and EMA."
)
DEFAULT_EXP_NAME = "20260901_twostage_sharedcond_ema"
