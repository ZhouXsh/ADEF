...
class Motion2Emo_Dataset(data.Dataset):
    def __init__(self, root_dir='src/my_prepare', gt_motion_filename="front_all_motions.pkl", motion_template_filename="motion_template.pkl", train_dataset="train.txt"):
    ...
    def __getitem__(self, index):
        while True:
            ...
            if gt_motion_exps.shape[0] < self.all_num + 2:
