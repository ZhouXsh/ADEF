"""Self-contained ICASSP27 controlled ablation: motion_partition.
...
# ICASSP27 ablation: motion_partition. Independent legacy implementation copy.
## 大一统版本。
...
class _CoreDitTalkingHead(nn.Module):
    ...
    def forward(self, motion_feat, audio_or_feat, prev_motion_feat=None,
        ...
        target_prediction = self.denoising_net(
