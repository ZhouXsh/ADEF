...
from src.modules.emotion_dit_ablation0905_attn_radius2 import DitTalkingHead
...
# -----------------------------------------------------------------------------
VARIANT_NAME = "ablation0905_attn_radius2"
VARIANT_DESCRIPTION = (
    'Audio cross-attention control with frame-local radius 2; all other final-6009 settings are unchanged.'
)
DEFAULT_EXP_NAME = "20260905_ablation_attn_radius2"
...
def build_parser():
    ...
    parser.add_argument("--model_variant", type=str, default="emotion_dit_ablation0905_attn_radius2")
