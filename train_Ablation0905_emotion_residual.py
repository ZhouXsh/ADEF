...
from src.modules.emotion_dit_ablation0905_emotion_residual import DitTalkingHead
...
# -----------------------------------------------------------------------------
VARIANT_NAME = "ablation0905_emotion_residual"
VARIANT_DESCRIPTION = (
...
DEFAULT_EXP_NAME = "20260905_ablation_emotion_residual"
...
def build_parser():
    ...
    parser.add_argument("--model_variant", type=str, default="emotion_dit_ablation0905_emotion_residual")
