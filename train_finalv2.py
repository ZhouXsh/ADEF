...
from src.modules.emotion_dit_finalv2 import DitTalkingHead
g_exp_name = "20260711_emotion_dit_finalv2"
g_device_id = 2
...
def build_parser():
    ...
    parser.add_argument('--device_id', type=int, default=g_device_id, help='cuda device id')
