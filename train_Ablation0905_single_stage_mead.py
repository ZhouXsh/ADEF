...
from src.modules.emotion_dit_ablation0905_single_stage_mead import DitTalkingHead
...
# -----------------------------------------------------------------------------
VARIANT_NAME = "ablation0905_single_stage_mead"
VARIANT_DESCRIPTION = (
...
DEFAULT_EXP_NAME = "20260905_ablation_single_stage_mead"
...
def build_parser():
    ...
    parser.add_argument("--model_variant", type=str, default="emotion_dit_ablation0905_single_stage_mead")
