...
# -----------------------------------------------------------------------------
VARIANT_NAME = "fusion_freezeaudio_protect_ema"
VARIANT_DESCRIPTION = "6009-based late-stage Pareto refinement."
DEFAULT_EXP_NAME = "20260904_fusion_freezeaudio_protect_ema"
...
def validate_args(args):
    ...
    phase3_start = args.stage1_iter + args.stage2_emotion_only_iter + 1
