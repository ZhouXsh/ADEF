...
from src.modules.emotion_dit_myfinalv1_expand import DitTalkingHead
g_exp_name = "20260712_emotion_dit_myfinalv1_expand"
device_id = 2
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_layers', type=int, default=10, help='number of encoder/decoder layers')
