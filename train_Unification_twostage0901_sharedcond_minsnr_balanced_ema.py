...
# -----------------------------------------------------------------------------
VARIANT_NAME = "sharedcond_minsnr_balanced_ema"
VARIANT_DESCRIPTION = (
    "Shared-condition warm-start, Min-SNR, balanced MEAD sampling, corrected schedule, validation, and EMA."
)
DEFAULT_EXP_NAME = "20260901_twostage_sharedcond_minsnr_balanced_ema"
