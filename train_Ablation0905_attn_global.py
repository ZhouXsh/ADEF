...
from src.modules.emotion_dit_ablation0905_attn_global import DitTalkingHead
...
# -----------------------------------------------------------------------------
VARIANT_NAME = "ablation0905_attn_global"
VARIANT_DESCRIPTION = (
    'Audio cross-attention control with no alignment mask (global acoustic memory); all other final-6009 settings are unchanged.'
)
DEFAULT_EXP_NAME = "20260905_ablation_attn_global"
...
def build_parser():
    ...
    parser.add_argument("--model_variant", type=str, default="emotion_dit_ablation0905_attn_global")
    ...
    parser.add_argument("--align_mask_width", type=int, default=0)
    parser.add_argument(
