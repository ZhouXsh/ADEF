...
from src.modules.emotion_dit_ablation0905_cond_late_token_concat import DitTalkingHead
...
# -----------------------------------------------------------------------------
VARIANT_NAME = "ablation0905_cond_late_token_concat"
VARIANT_DESCRIPTION = (
...
DEFAULT_EXP_NAME = "20260905_ablation_cond_late_token_concat"
...
def build_parser():
    ...
    parser.add_argument("--model_variant", type=str, default="emotion_dit_ablation0905_cond_late_token_concat")
