...
class SyncNetInstance(torch.nn.Module):
    ...
    def evaluate(self, opt, videofile):
        ...
        for fname in flist:
            ...
            # SyncNet's 3D-CNN was trained on 224x224 face crops.  Raw decoded
            # frames may be any size, so resize here to keep the FC layer's
            # expected flat dim (512) consistent.
