...
# -----------------------------------------------------------------------------
VARIANT_NAME = "schedule_ema"
VARIANT_DESCRIPTION = (
    "Corrected start/continuation loading, 190k+5k+240k budget, "
    "constant LR tail, validation, safe resume, and EMA."
)
DEFAULT_EXP_NAME = "20260901_twostage_schedule_ema"
DEFAULT_SHARED_CONDITION_WARMSTART = False
DEFAULT_USE_MIN_SNR = False
