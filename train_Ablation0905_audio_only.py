...
from src.modules.emotion_dit_ablation0905_audio_only import DitTalkingHead
...
# -----------------------------------------------------------------------------
VARIANT_NAME = "ablation0905_audio_only"
VARIANT_DESCRIPTION = (
...
DEFAULT_EXP_NAME = "20260905_ablation_audio_only"
...
def train(args, model, generic_dataset, mead_dataset, optimizer, save_dir,
    ...
    for iteration in range(start_iter + 1, args.max_iter + 1):
        ...
        should_step = has_backward_path and (
...
def build_parser():
    ...
    parser.add_argument("--model_variant", type=str, default="emotion_dit_ablation0905_audio_only")
