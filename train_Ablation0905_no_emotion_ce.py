...
from src.modules.emotion_dit_ablation0905_no_emotion_ce import DitTalkingHead
...
# -----------------------------------------------------------------------------
VARIANT_NAME = "ablation0905_no_emotion_ce"
VARIANT_DESCRIPTION = (
...
DEFAULT_EXP_NAME = "20260905_ablation_no_emotion_ce"
...
def build_parser():
    ...
    parser.add_argument("--model_variant", type=str, default="emotion_dit_ablation0905_no_emotion_ce")
