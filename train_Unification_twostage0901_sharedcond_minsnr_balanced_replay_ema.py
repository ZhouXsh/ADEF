...
# -----------------------------------------------------------------------------
VARIANT_NAME = "sharedcond_minsnr_balanced_replay_ema"
VARIANT_DESCRIPTION = (
    "Strong combined version with Min-SNR, balanced MEAD, and 5 percent generic continuation replay without changing emotion priors."
)
DEFAULT_EXP_NAME = "20260901_twostage_sharedcond_minsnr_balanced_replay_ema"
DEFAULT_SHARED_CONDITION_WARMSTART = True
DEFAULT_USE_MIN_SNR = True
DEFAULT_BALANCE_MEAD = True
DEFAULT_GENERIC_REPLAY_INTERVAL = 20
DEFAULT_MAX_ITER = 447000
