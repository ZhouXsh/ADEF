...
# -----------------------------------------------------------------------------
VARIANT_NAME = "sharedcond_balanced_ema"
VARIANT_DESCRIPTION = (
    "Shared-condition warm-start plus conservative emotion-level balanced MEAD sampling and EMA."
)
DEFAULT_EXP_NAME = "20260901_twostage_sharedcond_balanced_ema"
