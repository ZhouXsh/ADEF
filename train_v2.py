...
from src.modules.emotion_dit_v2 import DitTalkingHead


g_exp_name = "20260628_v2_phaseaware_emotion_tokens"
...
def build_parser():
    ...
    parser.add_argument('--device_id', type=int, default=1, help='cuda device id')
