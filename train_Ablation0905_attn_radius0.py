...
from src.modules.emotion_dit_ablation0905_attn_radius0 import DitTalkingHead
...
# -----------------------------------------------------------------------------
VARIANT_NAME = "ablation0905_attn_radius0"
VARIANT_DESCRIPTION = (
    'Audio cross-attention control with strict same-frame radius 0; all other final-6009 settings are unchanged.'
)
DEFAULT_EXP_NAME = "20260905_ablation_attn_radius0"
...
def build_parser():
    ...
    parser.add_argument("--model_variant", type=str, default="emotion_dit_ablation0905_attn_radius0")
